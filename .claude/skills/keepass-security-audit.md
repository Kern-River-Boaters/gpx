...
| :--- | :--- | :--- | :--- |
| **Jose Luis Pino** | `JLP`, `(JLP)`, `joseluis`, `jose luis`, `jpino@` | Active Primary User | `01_Finance`, `03_Work_Keysight`, etc. |
| **Lisa Maria Pino** | `LMP`, `(LMP)`, `lisapino`, `lisa pino`, `lpino@` | Active Primary User (Personal + Advising) | `01_Finance`, `04_Work_LILA_and_Advising` |
| **Isabel Pino** | `MIP`, `(MIP)`, `isabel` | Active Dependent Daughter | `09_Family_Isabel/` |
| **Madre (Maria Luisa Rexach)** | `Madre`, `(Madre)`, `marialuisarexach`, `maria4hope@yahoo.com` | Family Elder (Managed by Jose) | `10_Family_Madre/` |
| **Alister Pino (fka Susana)** | `SP`, `(SP)`, `susana`, `alister`, `8384249` | Independent Adult Kid (Trans son) | `Archive/Adult_Kids/` |
| **Ana Maria Pino** | `AMP`, `(AMP)`, `anamaria`, `ana pino`, `619422212` | Independent Adult Kid | `Archive/Adult_Kids/` |
| **Elena Maria Pino** | `EMP`, `(EMP)`, `elenapino`, `elena pino` | Independent Adult Kid | `Archive/Adult_Kids/` |
| **Eva Maria Pino** | `MEP`, `(MEP)`, `EMP`, `evampino`, `evapino`, `8137941` | Independent Adult Kid | `Archive/Adult_Kids/` |
| **Household / Shared** | — | Shared streaming, utilities, shopping, IoT | `05_Identity_and_Cloud`, `06_Shopping`, `07_Utilities` |
...
The canonical, simplified KeePass database hierarchy for **Jose Database.kdbx**:
...
├── Work - Lisa/                 (LILA portals, Lisa College Board, CommonApp Recommender)
├── Identity & Cloud/            (Google, Apple ID, Microsoft, GitHub, Bitbucket, AWS)
├── Entertainment/               (Netflix, HBO Max, Disney+, Hulu, Spotify, Peacock, Roku)
├── Shopping/                    (Amazon, Costco, Target, Best Buy, Coffee Roasting)
├── Travel/                      (Airlines [Delta, Alaska], Hotels, Rental Cars, Amtrak)
├── Utilities/                   (SoCalGas, SCE, Water, Trash, Verizon, Fastrak, DMV)
...
└── Archive/                     (Historical, inactive, and adult kids entries)
