...
* Select all the waypoints in each collection to set an icon. I recommend using the icons that render nicely on the Instinct: !Garmin Icons.: ![Garmin Icons](garmin-icons.png)
